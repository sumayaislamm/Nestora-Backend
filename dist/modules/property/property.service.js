...
// See All Category 
const getAllPropertiesFromDB = async (query) => {
    const { search, categoryId, availability, bedrooms, minRent, maxRent, page = 1, limit = 10, sortBy = "createdAt", sortOrder = "desc", } = query;
    const where = {};
    if (search) {
        where.OR = [
            {
