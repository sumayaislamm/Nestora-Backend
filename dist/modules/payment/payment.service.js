...
const createPaymentIntoDB = async (tenantId, payload) => {
...
const confirmPaymentIntoDB = async (paymentId) => {
...
//Get My Payments
const getMyPaymentsFromDB = async (tenantId) => {
...
const getSinglePaymentFromDB = async (paymentId, tenantId) => {
